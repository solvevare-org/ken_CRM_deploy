      ...
      try {
        ...
        if (response.success === true) {
          ...
          const personal = workspaces.filter(
            (ws: any) => ws.type === "personal" && !ws.invitedPending
          );
          const organization = workspaces.filter(
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200">
              <div className="p-6 border-b border-gray-200">
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Your individual workspace for personal projects
                </p>
              </div>
              <div className="p-6">
                ...
                {organizationWorkspaces.length === 0 ? (
                  <div className="text-center py-8">
                    ...
                    <p className="text-sm text-gray-400">
                      Click "Add Workspace" above to create your first
  ...
  return (
    ...
    >
      ...
      <div className="space-y-2 mb-4">
        ...
        {/* Features Status */}
        {workspace.white_label_configurations?.features_disabled &&
          workspace.white_label_configurations.features_disabled.length > 0 && (
            <div className="flex items-center justify-between text-sm">
              <span className="text-gray-600">Disabled Features</span>
              <span className="text-xs text-orange-600">
                {workspace.white_label_configurations.features_disabled.length}{" "}
                disabled
              </span>
            </div>
          )}
